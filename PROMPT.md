...
- [x] 修复这个BUG.
- [x] 提交Git Commit。
- [x] **更新本文件，将 Phase 10 标记为 [x]，然后退出!**

## ✅ Phase 11: bug-003Fix,exe文件的图标没有了变成了默认图标,启动exe后任务栏的图标也变成了默认的图标(对应 spec 07)

- [x] 修复这个BUG.
- [x] 重新生成exe文件并打开。
- [x] 提交Git Commit。
- [x] **更新本文件，将 Phase 11 标记为 [x]，然后退出!**

## Phase 12: 将窗口左上角的小图标应该换成应用图标(对应 spec 07)

- [] 完成这个任务.
- [] 重新生成exe文件并打开。
- [] 提交Git Commit。
- [] **更新本文件，将 Phase 12 标记为 [x]，然后退出!**
